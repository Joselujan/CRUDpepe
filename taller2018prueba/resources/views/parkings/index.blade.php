...
<div class="container">
    ...
    <a class="btn btn-success mb-3" href="{{ route('parkings.create')  }}">Agregar vehiculo</a>
    ...
    <table class="table">
        ...
        <tr>
            ...
            <td><a class="btn btn-info mb-1" href="{{ route('parkings.edit', $parking->id) }}">Editar</a></td>
            <td>
